              ...
              <div style={{display:"flex",flexDirection:"column",gap:"5px"}}>
                {top10.map((w,i)=>{
                  ...
                  <div key={w.id} style={{display:"flex",alignItems:"center",gap:"8px",padding:"8px 10px",background:isMastered?"rgba(60,180,100,0.04)":"rgba(255,255,255,0.03)",borderRadius:"8px",border:`1px solid ${isMastered?"rgba(60,180,100,0.2)":"rgba(255,255,255,0.06)"}`,opacity:isMastered?0.7:1}}>
                    <span style={{fontSize:"0.72rem",color:"rgba(255,255,255,0.25)",minWidth:"18px",flexShrink:0,textAlign:"center"}}>{i+1}</span>
                    ...
                    <div style={{flex:1,minWidth:0,display:"flex",alignItems:"baseline",gap:"8px"}}>
                      ...
                      <span style={{fontSize:"0.72rem",color:"rgba(255,255,255,0.4)",flex:1,minWidth:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{w.meaning}</span>
                    </div>
                    {/* 오답 횟수 + 바 */}
                    ...
                    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"6px",marginBottom:"12px"}}>
                      {T.verbExamples.map(([verb,hint])=>(
                        <button key={verb} onClick={()=>setPealimRoot(verb)} style={{padding:"7px 10px",borderRadius:"8px",background:"rgba(196,160,80,0.1)",border:"1px solid rgba(196,160,80,0.3)",color:"#c4a050",fontSize:"0.82rem",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:"6px"}}>
                          ...
                          <span style={{color:"rgba(255,255,255,0.4)",fontSize:"0.72rem"}}>{hint}</span>
                        </button>
                      ))}
                    </div>
