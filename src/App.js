          ...
          <div style={{paddingBottom:"80px"}}>
            ...
            {activeTab==="settings"&&(()=>{
              ...
              for(let i=195;i>=0;i--){
                ...
                const count=entry?entry.quizCount:0;
                heatCells.push({ds,count,dow:d.getDay()});
              }
              // 배지
              const badges=[];
                  ...
                  {showAnalytics&&(
                    <div style={{marginTop:"14px",display:"flex",flexDirection:"column",gap:"16px"}}>
                      ...
                      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"8px"}}>
                        {[
                          {icon:"learning",label:T.totalStudyDays(totalDays),color:"#9090b0"},
                          {icon:"mcq",label:T.totalQuizzes(totalQuizzes),color:"#c4a050"},
                          {icon:"mastered",label:T.totalCorrect(totalCorrect),color:"#60c880"},
                          {icon:"chart",label:T.accuracyRate(accuracy),color:accuracy>=80?"#60c880":accuracy>=60?"#c4a050":"#f07050"},
                        ].map((s,i)=>(
                      ...
                      <div style={{background:"rgba(196,160,80,0.06)",border:"1px solid rgba(196,160,80,0.2)",borderRadius:"12px",padding:"12px 16px"}}>
                        ...
                        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                          ...
                          {badges.length>0&&(
                            <div style={{display:"flex",gap:"4px"}}>
                              {badges.map((b,i)=>(
                                <span key={i} style={{display:"flex",alignItems:"center",gap:"4px",fontSize:"0.68rem",background:`rgba(${b.color==="#60c880"?"60,180,100":b.color==="#f07050"?"200,80,60":b.color==="#c4a050"?"196,160,80":"232,200,117"},0.12)`,border:`1px solid ${b.color}40`,borderRadius:"8px",padding:"3px 8px",color:b.color}}>
                      ...
                      <div>
                        <div style={{fontSize:"0.78rem",fontWeight:600,color:"rgba(255,255,255,0.6)",marginBottom:"8px",display:"flex",alignItems:"center",gap:"6px"}}>
                          <Icon name="learning" size={14} color="#9090b0"/>
                          {T.heatmapTitle}
                        </div>
                            ...
                            {Array.from({length:28},(_,wi)=>(
                              <div key={wi} style={{display:"flex",flexDirection:"column",gap:"3px"}}>
                                {Array.from({length:7},(_,di)=>{
                                  ...
                                  return(
                                    <div key={di} title={`${cell.ds}: ${cell.count}회`} style={{width:"11px",height:"11px",borderRadius:"2px",background:heatColor(cell.count),transition:"background 0.2s"}}/>
                                  );
                                })}
                              </div>
                            ))}
                        ...
                        <div style={{display:"flex",alignItems:"center",gap:"4px",marginTop:"6px",justifyContent:"flex-end"}}>
                          ...
                          {[0,1,2,3,5].map(n=>(
                            <div key={n} style={{width:"9px",height:"9px",borderRadius:"2px",background:heatColor(n)}}/>
                          ))}
                      ...
                      <div>
                        <div style={{fontSize:"0.78rem",fontWeight:600,color:"rgba(255,255,255,0.6)",marginBottom:"8px",display:"flex",alignItems:"center",gap:"6px"}}>
                          <Icon name="hard" size={14} color="#f07050"/>
                          {T.wrongTopTitle}
                        </div>
                        {top10.length===0?(
                          <div style={{fontSize:"0.78rem",color:"rgba(255,255,255,0.3)",textAlign:"center",padding:"16px 0"}}>{T.noAnalytics}</div>
                        ):(
