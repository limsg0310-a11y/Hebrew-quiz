...
const THEMES = {
  dark:{
    bg:"#17161C",card:th.card,cardHover:"#252430",
    border:th.border,borderMid:"rgba(255,255,255,0.12)",
      ...
      {[1,5,10].map(m=>(
        <button key={m} onClick={e=>{e.stopPropagation();if(!playing)setRepeatMode(m);}}
          style={{padding:"4px 8px",borderRadius:"6px",border:"1px solid",fontSize:"0.72rem",fontWeight:700,cursor:playing?"not-allowed":"pointer",
            background:repeatMode===m?"rgba(196,160,80,0.3)":th.inputBg,
            borderColor:repeatMode===m?"rgba(196,160,80,0.6)":th.border,
            color:repeatMode===m?"#c4a050":th.textMuted}}>
          {m}x
        </button>
      ))}
          ...
          <div style={{...S.modalOverlay,alignItems:"flex-start",paddingTop:"20px",overflowY:"auto"}}>
            <div style={{...S.modal,maxWidth:"600px",maxHeight:"90vh",overflowY:"auto"}}>
              ...
              {variantPasteMode==="paste"&&(
                <div>
                  <textarea style={{width:"100%",minHeight:"140px",background:th.inputBg,border:"1px solid rgba(80,160,120,0.3)",borderRadius:"10px",color:"#e8e6f0",padding:"12px",fontSize:"1rem",direction:"rtl",fontFamily:"Arial",resize:"vertical",outline:"none",lineHeight:1.8}} placeholder="여성형&#10;남성형&#10;..." lang="he" spellCheck={false} autoCorrect="off" value={variantPasteText} onChange={e=>setVariantPasteText(e.target.value)}/>
                                ...
                                <div style={{display:"flex",gap:"8px",alignItems:"flex-end",flexDirection:isMe?"row-reverse":"row",userSelect:"none",background:isSelected?"rgba(196,160,80,0.06)":"transparent",borderRadius:"10px",padding:"2px 4px"}}>
                                  ...
                                  <div style={{maxWidth:"72%"}}>
                                    ...
                                    <div
                                      ...
                                      style={{padding:"9px 13px",borderRadius:isMe?"14px 14px 4px 14px":"14px 14px 14px 4px",background:editingMsgId===msg.id?"rgba(196,160,80,0.3)":isMe?"#c4a050":th.border,color:isMe?"#17161C":"#e8e6f0",fontSize:"0.88rem",lineHeight:1.4,wordBreak:"break-word",cursor:isSelecting?"pointer":"default"}}
                                    >
                                      {msg.text}
                                    </div>
                                    {/* 시간 + 버튼들 */}
