...
const VARIANT_TYPES = [
  ...
  // 과거형
  { id:"past_1s",   label:{ko:"과거 — 나 (1인칭 단수)",           en:"Past — I"},           prompt:{ko:"나는 ~했다",           en:"I (past)"} },
  { id:"past_2ms",  label:{ko:"과거 — 너, 남성 (2인칭 남성 단수)", en:"Past — You (M)"},     prompt:{ko:"너는 ~했다 (남)",      en:"You M (past)"} },
  { id:"past_2fs",  label:{ko:"과거 — 너, 여성 (2인칭 여성 단수)", en:"Past — You (F)"},     prompt:{ko:"너는 ~했다 (여)",      en:"You F (past)"} },
  { id:"past_3ms",  label:{ko:"과거 — 그 (3인칭 남성 단수)",       en:"Past — He"},          prompt:{ko:"그는 ~했다",           en:"He (past)"} },
  { id:"past_3fs",  label:{ko:"과거 — 그녀 (3인칭 여성 단수)",     en:"Past — She"},         prompt:{ko:"그녀는 ~했다",         en:"She (past)"} },
  { id:"past_1p",   label:{ko:"과거 — 우리 (1인칭 복수)",          en:"Past — We"},          prompt:{ko:"우리는 ~했다",         en:"We (past)"} },
  { id:"past_2mp",  label:{ko:"과거 — 너희, 남성 (2인칭 남성 복수)",en:"Past — You pl.(M)"}, prompt:{ko:"너희는 ~했다 (남)",    en:"You pl. M (past)"} },
  { id:"past_2fp",  label:{ko:"과거 — 너희, 여성 (2인칭 여성 복수)",en:"Past — You pl.(F)"}, prompt:{ko:"너희는 ~했다 (여)",    en:"You pl. F (past)"} },
  { id:"past_3mp",  label:{ko:"과거 — 그들, 남성 (3인칭 남성 복수)",en:"Past — They (M)"},   prompt:{ko:"그들은 ~했다 (남)",    en:"They M (past)"} },
  { id:"past_3fp",  label:{ko:"과거 — 그들, 여성 (3인칭 여성 복수)",en:"Past — They (F)"},   prompt:{ko:"그들은 ~했다 (여)",    en:"They F (past)"} },
  // 현재형 (분사)
  { id:"pres_ms",   label:{ko:"현재 — 남성 단수",   en:"Present — M sg."},  prompt:{ko:"~하는 중 (남성 단수)",  en:"M sg. (present)"} },
  { id:"pres_fs",   label:{ko:"현재 — 여성 단수",   en:"Present — F sg."},  prompt:{ko:"~하는 중 (여성 단수)",  en:"F sg. (present)"} },
  { id:"pres_mp",   label:{ko:"현재 — 남성 복수",   en:"Present — M pl."},  prompt:{ko:"~하는 중 (남성 복수)",  en:"M pl. (present)"} },
  { id:"pres_fp",   label:{ko:"현재 — 여성 복수",   en:"Present — F pl."},  prompt:{ko:"~하는 중 (여성 복수)",  en:"F pl. (present)"} },
  // 미래형
  { id:"fut_1s",    label:{ko:"미래 — 나 (1인칭 단수)",            en:"Future — I"},         prompt:{ko:"나는 ~할 것이다",      en:"I (future)"} },
  { id:"fut_2ms",   label:{ko:"미래 — 너, 남성 (2인칭 남성 단수)", en:"Future — You (M)"},   prompt:{ko:"너는 ~할 것 (남)",     en:"You M (future)"} },
  { id:"fut_2fs",   label:{ko:"미래 — 너, 여성 (2인칭 여성 단수)", en:"Future — You (F)"},   prompt:{ko:"너는 ~할 것 (여)",     en:"You F (future)"} },
  { id:"fut_3ms",   label:{ko:"미래 — 그 (3인칭 남성 단수)",       en:"Future — He"},        prompt:{ko:"그는 ~할 것이다",      en:"He (future)"} },
  { id:"fut_3fs",   label:{ko:"미래 — 그녀 (3인칭 여성 단수)",     en:"Future — She"},       prompt:{ko:"그녀는 ~할 것이다",    en:"She (future)"} },
  { id:"fut_1p",    label:{ko:"미래 — 우리 (1인칭 복수)",          en:"Future — We"},        prompt:{ko:"우리는 ~할 것이다",    en:"We (future)"} },
  { id:"fut_2mp",   label:{ko:"미래 — 너희, 남성 (2인칭 남성 복수)",en:"Future — You pl.(M)"},prompt:{ko:"너희는 ~할 것 (남)",  en:"You pl. M (future)"} },
  { id:"fut_2fp",   label:{ko:"미래 — 너희, 여성 (2인칭 여성 복수)",en:"Future — You pl.(F)"},prompt:{ko:"너희는 ~할 것 (여)",  en:"You pl. F (future)"} },
  { id:"fut_3mp",   label:{ko:"미래 — 그들, 남성 (3인칭 남성 복수)",en:"Future — They (M)"}, prompt:{ko:"그들은 ~할 것 (남)",   en:"They M (future)"} },
  { id:"fut_3fp",   label:{ko:"미래 — 그들, 여성 (3인칭 여성 복수)",en:"Future — They (F)"}, prompt:{ko:"그들은 ~할 것 (여)",   en:"They F (future)"} },
  // 명령형
  { id:"imp_2ms",   label:{ko:"명령 — 너, 남성 (2인칭 남성 단수)", en:"Imperative — You (M)"},   prompt:{ko:"~해라! (남성 단수)",  en:"Do! (M sg.)"} },
  { id:"imp_2fs",   label:{ko:"명령 — 너, 여성 (2인칭 여성 단수)", en:"Imperative — You (F)"},   prompt:{ko:"~해라! (여성 단수)",  en:"Do! (F sg.)"} },
  { id:"imp_2mp",   label:{ko:"명령 — 너희, 남성 (2인칭 남성 복수)",en:"Imperative — You pl.(M)"},prompt:{ko:"~해라! (남성 복수)", en:"Do! (M pl.)"} },
  { id:"imp_2fp",   label:{ko:"명령 — 너희, 여성 (2인칭 여성 복수)",en:"Imperative — You pl.(F)"},prompt:{ko:"~해라! (여성 복수)", en:"Do! (F pl.)"} },
  // 소유격
  { id:"poss_1s",   label:{ko:"소유격 — 나의",            en:"Poss. — My"},           prompt:{ko:"나의 ~는?",         en:"My ~?"} },
  { id:"poss_2ms",  label:{ko:"소유격 — 너의, 남성",      en:"Poss. — Your (M)"},     prompt:{ko:"너의 ~ (남)?",      en:"Your (M) ~?"} },
  { id:"poss_2fs",  label:{ko:"소유격 — 너의, 여성",      en:"Poss. — Your (F)"},     prompt:{ko:"너의 ~ (여)?",      en:"Your (F) ~?"} },
  { id:"poss_3ms",  label:{ko:"소유격 — 그의",            en:"Poss. — His"},          prompt:{ko:"그의 ~는?",         en:"His ~?"} },
  { id:"poss_3fs",  label:{ko:"소유격 — 그녀의",          en:"Poss. — Her"},          prompt:{ko:"그녀의 ~는?",       en:"Her ~?"} },
  { id:"poss_1p",   label:{ko:"소유격 — 우리의",          en:"Poss. — Our"},          prompt:{ko:"우리의 ~는?",       en:"Our ~?"} },
  { id:"poss_2mp",  label:{ko:"소유격 — 너희의, 남성",    en:"Poss. — Your pl.(M)"}, prompt:{ko:"너희의 ~ (남)?",    en:"Your pl. (M) ~?"} },
  { id:"poss_2fp",  label:{ko:"소유격 — 너희의, 여성",    en:"Poss. — Your pl.(F)"}, prompt:{ko:"너희의 ~ (여)?",    en:"Your pl. (F) ~?"} },
  { id:"poss_3mp",  label:{ko:"소유격 — 그들의, 남성",    en:"Poss. — Their (M)"},   prompt:{ko:"그들의 ~ (남)?",    en:"Their (M) ~?"} },
  { id:"poss_3fp",  label:{ko:"소유격 — 그들의, 여성",    en:"Poss. — Their (F)"},   prompt:{ko:"그들의 ~ (여)?",    en:"Their (F) ~?"} },
  // to부정사
  { id:"infinitive",label:{ko:"to부정사 (원형)",          en:"Infinitive"},           prompt:{ko:"동사 원형은?",      en:"Infinitive form?"} },
];
