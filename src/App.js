          ...
          <div style={{paddingBottom:"80px"}}>
            ...
            {activeTab==="add"&&(
              <div>
                ...
                <div style={{display:"flex",gap:"4px",background:"rgba(255,255,255,0.04)",borderRadius:"10px",padding:"4px",marginBottom:"16px",overflowX:"auto",scrollbarWidth:"none"}}>
                  {(currentBook==="hebrew"
                    ?[["form","직접 입력"],["reverso","Reverso"],["root","어근 검색"],["meaning","뜻 검색"],["batch","일괄 추가"]]
                    :[["form","직접 입력"],["meaning","뜻 검색"],["batch","일괄 추가"]]
                  ).map(([v,l])=>(
                      ...
                      <div>
                        <div style={{background:"rgba(80,160,120,0.08)",border:"1px solid rgba(80,160,120,0.2)",borderRadius:"10px",padding:"14px",marginBottom:"10px"}}>
                          ...
                          <div style={{marginBottom:"10px"}}>
                            <div style={{fontSize:"0.72rem",color:"rgba(255,255,255,0.5)",marginBottom:"5px"}}>품사 선택 (선택사항)</div>
                            <div style={{display:"flex",gap:"5px",flexWrap:"wrap"}}>
                              <button onClick={()=>setPealimPreview(p=>({...p,wordType:null}))} style={{padding:"4px 10px",borderRadius:"7px",fontSize:"0.75rem",cursor:"pointer",border:"1px solid",background:!pealimPreview.wordType?"rgba(255,255,255,0.12)":"rgba(255,255,255,0.04)",borderColor:!pealimPreview.wordType?"rgba(255,255,255,0.3)":"rgba(255,255,255,0.1)",color:!pealimPreview.wordType?"#e8e6f0":"rgba(255,255,255,0.35)"}}>⚪ 선택 안함</button>
                              {WORD_TYPES.map(wt=>(
            ...
            {activeTab==="quiz"&&(
              <div style={{display:"flex",flexDirection:"column",gap:"8px"}}>
                {/* 퀴즈 섹션 아코디언 헬퍼 */}
                {[
                  {key:"mcq",  icon:"🎯", title:"객관식",   color:"#c4a050", cnt:poolSize},
                  {key:"essay",icon:"✍️", title:"서술형",   color:"#9060f0", cnt:essayPoolSize},
                  ...(currentBook==="hebrew"?[{key:"variant",icon:"🔀",title:"변형 퀴즈",color:"#50c898",cnt:variantPoolSize}]:[]),
                ].map(qt=>{
                    ...
                    <div key={qt.key} style={{background:"#1E1D24",border:`1px solid ${isOpen?qt.color+"50":"rgba(255,255,255,0.08)"}`,borderRadius:"14px",overflow:"hidden",transition:"border-color 0.2s"}}>
                      ...
                      <button onClick={()=>setOpenQuizSection(isOpen?null:qt.key)} style={{width:"100%",display:"flex",alignItems:"center",gap:"12px",padding:"14px 16px",background:"transparent",border:"none",cursor:"pointer",textAlign:"left"}}>
                        ...
                        <div style={{flex:1}}>
                          ...
                          <div style={{fontSize:"0.68rem",color:"rgba(255,255,255,0.35)",marginTop:"1px"}}>{qt.cnt}개 단어 가능</div>
                        </div>
                      ...
                      {isOpen&&(
                        <div style={{padding:"0 16px 16px",borderTop:`1px solid ${qt.color}20`}}>
                          {qt.key==="mcq"&&(<>
                            <p style={{...S.settingLabel,marginTop:"14px"}}>문제 방향</p>
