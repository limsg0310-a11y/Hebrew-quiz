...
<img src={DOVE_IMG} alt="logo" style={{width:"170%",height:"170%",objectFit:"contain",filter:theme==="dark"?"brightness(1.5) contrast(1.2)":"none"}}/>
</div>
<div>
...
<img src={user.photoURL} alt="" style={{width:"26px",height:"26px",borderRadius:"50%",border:"1px solid rgba(196,160,80,0.5)"}}/>
