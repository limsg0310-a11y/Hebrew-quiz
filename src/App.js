...
const THEMES = {
  ...
  light:{
    bg:"#f0ede8",card:"#ffffff",cardHover:"#f8f6f2",
    border:"rgba(0,0,0,0.08)",borderMid:"rgba(0,0,0,0.12)",
    text:"#1a1820",textSub:"rgba(0,0,0,0.45)",textMuted:"rgba(0,0,0,0.28)",
    inputBg:"rgba(0,0,0,0.04)",inputBorder:"rgba(0,0,0,0.12)",
    btnSecBg:"rgba(0,0,0,0.05)",btnSecBorder:"rgba(0,0,0,0.10)",btnSecColor:"rgba(0,0,0,0.70)",
    navBg:"#ffffff",navBorder:"rgba(0,0,0,0.08)",
    filterBg:"rgba(0,0,0,0.03)",filterColor:"rgba(0,0,0,0.40)",
    optBg:"rgba(0,0,0,0.03)",optColor:"rgba(0,0,0,0.85)",
    wordMeanColor:"rgba(0,0,0,0.80)",emptyColor:"rgba(0,0,0,0.25)",
    shadow:"rgba(0,0,0,0.15)",nebula:false,
  },
};
...
function AnalyticsSection({studyLog,words,uiLang,T,showAnalytics,setShowAnalytics,setWords,showToast,onStudyWrong}){
  ...
  const S2={card:{background:th.card,borderRadius:"14px",border:"1px solid rgba(255,255,255,0.08)",padding:"14px 16px"},emptyMsg:{textAlign:"center",color:"rgba(255,255,255,0.3)",padding:"20px 0",fontSize:"0.82rem"}};
  return(
    <div style={{...S2.card}}>
...
`}</style>
      ...
      <div style={S.container}>
        ...
        <header style={{
          ...
          backgroundImage:th.nebula?`url(${NEBULA_BG})`:"none",
          backgroundColor:th.nebula?"transparent":th.card,
          backgroundSize:"cover",backgroundPosition:"center 40%",
          border:`1px solid ${th.nebula?"rgba(196,160,80,0.25)":th.border}`
        }}>
          {/* 어두운 오버레이 (다크 모드만) */}
          {th.nebula&&<div style={{position:"absolute",inset:0,background:"linear-gradient(135deg,rgba(15,12,25,0.82),rgba(20,15,35,0.75))",borderRadius:"16px"}}/>}          {/* 콘텐츠 */}
                        ...
                        {profilePopup&&(
                          <div style={{position:"fixed",inset:0,zIndex:950,background:"rgba(0,0,0,0.3)"}} onClick={()=>setProfilePopup(null)}>
                            <div onClick={e=>e.stopPropagation()} style={{position:"absolute",top:profilePopup.y,left:profilePopup.x,background:th.card,borderRadius:"16px",border:`1px solid ${th.borderMid}`,padding:"16px",width:"180px",boxShadow:"0 8px 32px rgba(0,0,0,0.7)",zIndex:951}}>
                              <div style={{width:"32px",height:"3px",borderRadius:"2px",background:"rgba(255,255,255,0.12)",margin:"0 auto 14px"}}/>
                              <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:"8px",marginBottom:"14px"}}>
                                ...
                                <div style={{fontWeight:600,fontSize:"0.88rem",color:"#e8e6f0",textAlign:"center"}}>{profilePopup.displayName}</div>
                              </div>
                              <div style={{display:"flex",flexDirection:"column",gap:"6px"}}>
                      ...
                      <div style={{flex:1,overflowY:"auto"}}>
                        ...
                        <div style={{...S.card,marginBottom:"12px"}}>
                          ...
                          {friendSearchResult&&(friendSearchResult.notFound?(
                            ...
                            <div style={{display:"flex",alignItems:"center",gap:"10px",padding:"10px 12px",background:th.inputBg,borderRadius:"10px"}}>
