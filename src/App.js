            ...
            {top10.length===0?(
              ...
              <div style={{display:"flex",flexDirection:"column",gap:"5px"}}>
                  ...
                  <div key={w.id} style={{display:"flex",alignItems:"center",gap:"8px",padding:"8px 10px",background:isMastered?"rgba(60,180,100,0.04)":th.filterBg,borderRadius:"8px",border:`1px solid ${isMastered?"rgba(60,180,100,0.2)":th.inputBg}`,opacity:isMastered?0.7:1}}>
                    ...
                    <div style={{display:"flex",alignItems:"center",gap:"6px",flexShrink:0}}>
                      ...
                      <button
                        ...
                        style={{padding:"2px 6px",borderRadius:"5px",border:"1px solid rgba(255,255,255,0.12)",background:th.inputBg,color:th.textMuted,cursor:"pointer",fontSize:"0.6rem",flexShrink:0,lineHeight:1.4}}
                      >
                        {T.resetWrongCount}
                      </button>
                    </div>
                ...
                <button
                  ...
                  style={{marginTop:"4px",width:"100%",padding:"7px",borderRadius:"8px",border:"1px solid rgba(255,255,255,0.1)",background:th.filterBg,color:th.textMuted,cursor:"pointer",fontSize:"0.72rem",display:"flex",alignItems:"center",justifyContent:"center",gap:"5px"}}
                >
