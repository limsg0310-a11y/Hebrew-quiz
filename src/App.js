...
`}</style>
      ...
      <div style={S.container}>
        ...
        <header style={{
          ...
          backgroundSize:"cover",backgroundPosition:th.nebula?"center 40%":"center 20%",
          border:`1px solid ${th.nebula?"rgba(196,160,80,0.25)":th.border}`,
          minHeight:theme==="light"?"130px":"auto"
        }}>
          {/* 오버레이 */}
          ...
          {theme==="light"&&<div style={{position:"absolute",inset:0,background:"linear-gradient(to bottom,rgba(255,255,255,0) 0%,rgba(255,255,255,0) 38%,rgba(255,255,255,0.94) 58%,rgba(255,255,255,0.98) 100%)",borderRadius:"16px"}}/>}
          {/* 콘텐츠 - 아래쪽에 배치 */}
          <div style={{position:"relative",zIndex:1,padding:theme==="light"?"76px 16px 14px":"14px 16px",display:"flex",flexDirection:"column",gap:"8px"}}>
            {/* 1행: 로고 + 앱 이름 */}
            <div style={{display:"flex",alignItems:"center",gap:"10px"}}>
              <span style={{...S.logo,border:"1px solid rgba(196,160,80,0.5)",boxShadow:"0 0 12px rgba(196,160,80,0.2)"}}>אב</span>
              <div>
                <h1 style={{...S.title,fontSize:"1.15rem",whiteSpace:"nowrap",fontFamily:"'Noto Sans KR',sans-serif",fontWeight:600,textShadow:th.nebula?"0 1px 8px rgba(0,0,0,0.8)":"none",letterSpacing:"-0.3px",color:theme==="light"?"#202124":th.text}}>
            ...
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
              <div style={S.statsRow}>
                <div style={{...S.statBadge,color:"#2d8a50",background:"rgba(60,180,100,0.15)",border:"1px solid rgba(60,180,100,0.5)",backdropFilter:th.nebula?"blur(4px)":"none",display:"flex",alignItems:"center",gap:"3px"}}><Icon name="mastered" size={13} color="#2d8a50"/>{masteredCount}</div>
                <div style={{...S.statBadge,color:"#c84030",background:"rgba(200,80,60,0.12)",border:"1px solid rgba(200,80,60,0.45)",backdropFilter:th.nebula?"blur(4px)":"none",display:"flex",alignItems:"center",gap:"3px"}}><Icon name="hard" size={13} color="#c84030"/>{hardCount}</div>
                <div style={{...S.statBadge,color:"#a07020",background:"rgba(196,160,80,0.15)",border:"1px solid rgba(196,160,80,0.5)",backdropFilter:th.nebula?"blur(4px)":"none",display:"flex",alignItems:"center",gap:"3px"}}><Icon name="learning" size={13} color="#a07020"/>{learningCount}</div>
              </div>
              <div style={{display:"flex",alignItems:"center",gap:"6px"}}>
                {user?(
