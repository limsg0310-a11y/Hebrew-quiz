      ...
      <div style={S.container}>
        ...
        <header style={S.header}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:"10px",width:"100%",marginBottom:"8px"}}>
            ...
            <div style={{flex:1,minWidth:0}}>
              <h1 style={{...S.title,fontSize:"clamp(0.95rem,4vw,1.1rem)",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>
                {uiLang==="ko"?"히브리어 단어 퀴즈":"Hebrew Quiz"}
              </h1>
              <div style={{fontSize:"0.62rem",color:ttsReady?"#60c880":"#f07050"}}>{ttsReady?T.ttsHeader(true):T.ttsHeader(false)}</div>
            </div>
