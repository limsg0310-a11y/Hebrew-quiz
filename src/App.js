...
// ── SVG 아이콘 컴포넌트 ──
function AnalyticsSection({studyLog,words,uiLang,T,showAnalytics,setShowAnalytics,setWords,showToast,onStudyWrong}){
  ...
  const heatColor=(n)=>n===0?"rgba(255,255,255,0.06)":n===1?"rgba(196,160,80,0.25)":n===2?"rgba(196,160,80,0.5)":n<=4?"rgba(196,160,80,0.75)":"#c4a050";
  const S2={card:{background:"#1E1D24",borderRadius:"14px",border:"1px solid rgba(255,255,255,0.08)",padding:"14px 16px"},emptyMsg:{textAlign:"center",color:"rgba(255,255,255,0.3)",padding:"20px 0",fontSize:"0.82rem"}};
  return(
    <div style={{...S2.card}}>
      <button onClick={()=>setShowAnalytics(v=>!v)} style={{width:"100%",display:"flex",alignItems:"center",justifyContent:"space-between",background:"none",border:"none",cursor:"pointer",padding:0}}>
        <div style={{display:"flex",alignItems:"center",gap:"8px"}}>
          ...
          <span style={{fontSize:"0.88rem",fontWeight:700,color:"rgba(255,255,255,0.9)"}}>{T.analyticsTitle}</span>
        ...
        <Icon name={showAnalytics?"mastered":"add"} size={16} color="rgba(255,255,255,0.4)"/>
      </button>
      {showAnalytics&&(
        <div style={{marginTop:"14px",display:"flex",flexDirection:"column",gap:"16px"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"8px"}}>
            {[{icon:"learning",label:T.totalStudyDays(totalDays),color:"#9090b0"},{icon:"mcq",label:T.totalQuizzes(totalQuizzes),color:"#c4a050"},{icon:"mastered",label:T.totalCorrect(totalCorrect),color:"#60c880"},{icon:"chart",label:T.accuracyRate(accuracy),color:accuracy>=80?"#60c880":accuracy>=60?"#c4a050":"#f07050"}].map((s,i)=>(
              <div key={i} style={{background:"rgba(255,255,255,0.04)",borderRadius:"10px",padding:"10px 12px",display:"flex",alignItems:"center",gap:"8px"}}>
          ...
          <div style={{background:"rgba(196,160,80,0.06)",border:"1px solid rgba(196,160,80,0.2)",borderRadius:"12px",padding:"12px 16px"}}>
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"10px"}}>
              <div style={{display:"flex",alignItems:"center",gap:"8px"}}>
                ...
                <span style={{fontSize:"0.85rem",fontWeight:700,color:"rgba(255,255,255,0.9)"}}>{T.streakTitle}</span>
              </div>
              <div style={{textAlign:"right"}}>
                <div style={{fontSize:"1.5rem",fontWeight:800,color:"#c4a050",lineHeight:1}}>{streak}</div>
                <div style={{fontSize:"0.62rem",color:"rgba(255,255,255,0.4)"}}>{uiLang==="ko"?"일":"days"}</div>
              </div>
            </div>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
              <span style={{fontSize:"0.72rem",color:"rgba(255,255,255,0.4)"}}>{T.streakBest(best)}</span>
              {badges.length>0&&(
                <div style={{display:"flex",gap:"4px"}}>
                  {badges.map((b,i)=>(
                    <span key={i} style={{display:"flex",alignItems:"center",gap:"4px",fontSize:"0.68rem",background:"rgba(255,255,255,0.06)",border:`1px solid ${b.color}40`,borderRadius:"8px",padding:"3px 8px",color:b.color}}>
          ...
          {/* 히트맵 */}
          <div>
            <div style={{fontSize:"0.78rem",fontWeight:600,color:"rgba(255,255,255,0.6)",marginBottom:"8px",display:"flex",alignItems:"center",gap:"6px"}}>
            ...
            <div style={{display:"flex",alignItems:"center",gap:"4px",marginTop:"6px",justifyContent:"flex-end"}}>
              <span style={{fontSize:"0.6rem",color:"rgba(255,255,255,0.3)"}}>{uiLang==="ko"?"적음":"Less"}</span>
              {[0,1,2,3,5].map(n=><div key={n} style={{width:"9px",height:"9px",borderRadius:"2px",background:heatColor(n)}}/>)}
              <span style={{fontSize:"0.6rem",color:"rgba(255,255,255,0.3)"}}>{uiLang==="ko"?"많음":"More"}</span>
            </div>
          </div>
          {/* TOP 10 */}
          <div>
            <div style={{fontSize:"0.78rem",fontWeight:600,color:"rgba(255,255,255,0.6)",marginBottom:"8px",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
              <div style={{display:"flex",alignItems:"center",gap:"6px"}}>
                <Icon name="hard" size={14} color="#f07050"/>{T.wrongTopTitle}
              </div>
              <div style={{display:"flex",alignItems:"center",gap:"8px",fontSize:"0.6rem",color:"rgba(255,255,255,0.3)"}}>
            ...
            {top10.length===0?(
              ...
              <div style={{display:"flex",flexDirection:"column",gap:"5px"}}>
                {top10.map((w,i)=>{
                  ...
                  return(
                  <div key={w.id} style={{display:"flex",alignItems:"center",gap:"8px",padding:"8px 10px",background:isMastered?"rgba(60,180,100,0.04)":"rgba(255,255,255,0.03)",borderRadius:"8px",border:`1px solid ${isMastered?"rgba(60,180,100,0.2)":"rgba(255,255,255,0.06)"}`,opacity:isMastered?0.7:1}}>
                    <span style={{fontSize:"0.72rem",color:"rgba(255,255,255,0.25)",minWidth:"16px",textAlign:"right"}}>{i+1}</span>
                    {/* 상태 아이콘 */}
                    <Icon name={stIcon} size={13} color={stColor}/>
                    <span style={{fontFamily:"Arial",direction:"rtl",fontSize:"0.95rem",color:isMastered?"#80c890":"#c4a050",flex:1,minWidth:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{w.hebrew}</span>
                    <span style={{fontSize:"0.72rem",color:"rgba(255,255,255,0.4)",maxWidth:"90px",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{w.meaning}</span>
                    {/* 오답 횟수 + 바 */}
                    <div style={{display:"flex",alignItems:"center",gap:"6px",flexShrink:0}}>
                      ...
                      <button
                        ...
                        style={{padding:"2px 6px",borderRadius:"5px",border:"1px solid rgba(255,255,255,0.12)",background:"rgba(255,255,255,0.05)",color:"rgba(255,255,255,0.4)",cursor:"pointer",fontSize:"0.6rem",flexShrink:0,lineHeight:1.4}}
                      >
                        {T.resetWrongCount}
                      </button>
                    </div>
                ...
                <button
                  ...
                  style={{marginTop:"4px",width:"100%",padding:"7px",borderRadius:"8px",border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.03)",color:"rgba(255,255,255,0.35)",cursor:"pointer",fontSize:"0.72rem",display:"flex",alignItems:"center",justifyContent:"center",gap:"5px"}}
                >
                  <Icon name="refresh" size={12} color="rgba(255,255,255,0.35)"/>
              ...
              <div>
                ...
                {addSubView==="form"&&(
                  <div style={{display:"flex",flexDirection:"column",gap:"10px"}}>
                    ...
                    <div style={{...S.ioCard,borderColor:"rgba(196,160,80,0.15)"}}>
                      <div style={{fontSize:"0.82rem",fontWeight:600,color:"rgba(255,255,255,0.75)",marginBottom:"8px"}}><Icon name="save" size={15} color="rgba(255,255,255,0.75)" style={{marginRight:6}}/>{T.saveLoad}</div>
                      <div style={{display:"flex",gap:"6px",flexWrap:"wrap"}}>
                        ...
                        <button style={S.btnIO("rgba(255,255,255,0.75)","rgba(255,255,255,0.06)","rgba(255,255,255,0.15)")} onClick={()=>fileInputRef.current.click()}><Icon name="import" size={14} style={{marginRight:4}}/>{T.fileOpen}</button>
                ...
                {addSubView==="meaning"&&(
                  <div style={S.card}>
                    ...
                    <p style={{fontSize:"0.78rem",color:"rgba(255,255,255,0.4)",marginBottom:"10px"}}>{T.meaningSearchDesc(bookInfo)}</p>
                    <div style={{display:"flex",gap:"8px",marginBottom:"10px"}}>
            ...
            {activeTab==="settings"&&(
              <div style={{display:"flex",flexDirection:"column",gap:"10px"}}>
                ...
                <AnalyticsSection
                  ...
                  setWords={setWords} showToast={showToast}
                ...
                {/* 저장/불러오기 */}
                <div style={S.card}>
                  <div style={{fontSize:"0.82rem",fontWeight:600,color:"rgba(255,255,255,0.75)",marginBottom:"12px"}}><Icon name="save" size={15} color="rgba(255,255,255,0.75)" style={{marginRight:6}}/>{T.saveLoad}</div>
                  <div style={{display:"flex",gap:"6px",flexWrap:"wrap"}}>
                  ...
                  <>
                    ...
                    {chatTab==="global"&&(()=>{
                      ...
                      <div style={{display:"flex",flexDirection:"column",flex:1,minHeight:0}}>
                        {/* 프로필 팝업 */}
                        {profilePopup&&(
                          <div style={{position:"fixed",inset:0,zIndex:950}} onClick={()=>setProfilePopup(null)}>
                            <div onClick={e=>e.stopPropagation()} style={{position:"absolute",top:Math.min(profilePopup.y,window.innerHeight-220),left:Math.min(profilePopup.x,window.innerWidth-180),background:"#1E1D24",borderRadius:"14px",border:"1px solid rgba(255,255,255,0.12)",padding:"14px",width:"170px",boxShadow:"0 8px 32px rgba(0,0,0,0.6)",zIndex:951}}>
                              <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:"8px",marginBottom:"12px"}}>
                                <img src={profilePopup.photoURL||`https://ui-avatars.com/api/?name=${encodeURIComponent(profilePopup.displayName||"?")}`} alt="" style={{width:"52px",height:"52px",borderRadius:"50%",border:"2px solid rgba(196,160,80,0.4)"}}/>
                                <div style={{fontWeight:600,fontSize:"0.85rem",color:"#e8e6f0",textAlign:"center"}}>{profilePopup.displayName}</div>
                              </div>
                        ...
                        {isSelecting&&(
                          <div style={{display:"flex",alignItems:"center",gap:"8px",padding:"8px 12px",background:"rgba(196,160,80,0.08)",borderRadius:"10px",marginBottom:"6px",border:"1px solid rgba(196,160,80,0.2)"}}>
                            ...
                            <button onClick={()=>setSelectedMsgs(new Set())} style={{padding:"5px 10px",borderRadius:"7px",background:"rgba(255,255,255,0.06)",border:"1px solid rgba(255,255,255,0.1)",color:"rgba(255,255,255,0.5)",cursor:"pointer",fontSize:"0.75rem"}}>
                              {uiLang==="ko"?"취소":"Cancel"}
                            </button>
                          </div>
                        )}
                              ...
                              <div key={msg.id}>
                                ...
                                {showDate&&(
                                  <div style={{textAlign:"center",margin:"10px 0 6px",display:"flex",alignItems:"center",gap:"8px"}}>
                                    ...
                                    <span style={{fontSize:"0.6rem",color:"rgba(255,255,255,0.3)",background:"#17161C",padding:"2px 8px",borderRadius:"8px",flexShrink:0}}>{getDateLabel(msg.createdAt)}</span>
                                    <div style={{flex:1,height:"1px",background:"rgba(255,255,255,0.08)"}}/>
                                  </div>
                                )}
                                {/* 안읽음 구분선 */}
                                ...
                                <div style={{display:"flex",gap:"8px",alignItems:"flex-end",flexDirection:isMe?"row-reverse":"row",userSelect:"none",background:isSelected?"rgba(196,160,80,0.06)":"transparent",borderRadius:"10px",padding:"2px 4px"}}>
                                  ...
                                  {!isMe&&(
                                    <img
                                      ...
                                      onContextMenu={e=>{e.preventDefault();setProfilePopup({uid:msg.uid,displayName:msg.displayName,photoURL:msg.photoURL,x:e.clientX,y:e.clientY});}}
                                      onTouchStart={(e)=>{const t=setTimeout(()=>setProfilePopup({uid:msg.uid,displayName:msg.displayName,photoURL:msg.photoURL,x:e.touches[0].clientX,y:e.touches[0].clientY}),600);e.currentTarget._t=t;}}
                                  ...
                                  <div style={{maxWidth:"72%"}}>
                                    ...
                                    {/* 답장 미리보기 */}
                                    {msg.replyTo&&(
                                      <div style={{borderLeft:"2px solid rgba(196,160,80,0.5)",paddingLeft:"8px",marginBottom:"5px",fontSize:"0.7rem",color:"rgba(255,255,255,0.4)",background:"rgba(255,255,255,0.04)",borderRadius:"0 6px 6px 0",padding:"4px 8px"}}>
                                    ...
                                    <div
                                      ...
                                      style={{padding:"9px 13px",borderRadius:isMe?"14px 14px 4px 14px":"14px 14px 14px 4px",background:editingMsgId===msg.id?"rgba(196,160,80,0.3)":isMe?"#c4a050":"rgba(255,255,255,0.08)",color:isMe?"#17161C":"#e8e6f0",fontSize:"0.88rem",lineHeight:1.4,wordBreak:"break-word",cursor:isSelecting?"pointer":"default"}}
                                    >
                                      {msg.text}
                                    </div>
                                    {/* 시간 + 버튼들 */}
                                    <div style={{fontSize:"0.6rem",color:"rgba(255,255,255,0.25)",marginTop:"3px",textAlign:isMe?"right":"left",display:"flex",gap:"6px",justifyContent:isMe?"flex-end":"flex-start",alignItems:"center"}}>
                                      {timeStr}
                                      {msg.edited&&<span style={{color:"rgba(255,255,255,0.3)",fontStyle:"italic"}}>Edited</span>}
                                      {/* 답장 버튼 (항상) */}
                                      <button onClick={()=>setReplyTo(msg)} style={{background:"none",border:"none",cursor:"pointer",padding:"1px 3px",borderRadius:"4px",color:"rgba(255,255,255,0.25)",fontSize:"0.65rem",display:"flex",alignItems:"center",gap:"2px"}} title="Reply">
                                        ↩
                                      </button>
                                      {/* 수정/삭제 (내 메시지) */}
                                      {isMe&&(
                                        <>
                                          <button onClick={()=>startEditMsg(msg)} style={{background:"none",border:"none",cursor:"pointer",padding:"1px",borderRadius:"4px",color:"rgba(255,255,255,0.3)"}}>
                                            <Icon name="edit" size={10} color="rgba(255,255,255,0.3)"/>
                                          </button>
                                          <button onClick={()=>{const s=new Set([msg.id]);setSelectedMsgs(s);}} style={{background:"none",border:"none",cursor:"pointer",padding:"1px",borderRadius:"4px",color:"rgba(255,255,255,0.3)"}}>
                                            <Icon name="trash" size={10} color="rgba(255,255,255,0.3)"/>
                                          </button>
                                        </>
                                      )}
                                    </div>
                        ...
                        <div style={{paddingTop:"8px",borderTop:"1px solid rgba(255,255,255,0.08)"}}>
                          {/* 답장 프리뷰 */}
                          {replyTo&&(
                            <div style={{display:"flex",alignItems:"center",gap:"8px",padding:"6px 10px",background:"rgba(255,255,255,0.04)",borderRadius:"8px",marginBottom:"6px",borderLeft:"2px solid #c4a050"}}>
                              <div style={{flex:1,minWidth:0}}>
                                <div style={{fontSize:"0.65rem",color:"#c4a050",fontWeight:600}}>{replyTo.displayName}</div>
                                <div style={{fontSize:"0.75rem",color:"rgba(255,255,255,0.5)",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{replyTo.text}</div>
                              </div>
                              <button onClick={()=>setReplyTo(null)} style={{background:"none",border:"none",color:"rgba(255,255,255,0.4)",cursor:"pointer",fontSize:"0.9rem"}}>✕</button>
                            </div>
                          )}
                          {editingMsgId&&(
                    ...
                    {chatTab==="dm"&&dmTarget&&(()=>{
                      ...
                      <div style={{display:"flex",flexDirection:"column",flex:1,minHeight:0}}>
                        ...
                        <div style={{display:"flex",alignItems:"center",gap:"10px",marginBottom:"10px",padding:"8px 12px",background:"rgba(255,255,255,0.04)",borderRadius:"10px"}}>
                          ...
                          <span style={{fontWeight:600,fontSize:"0.88rem",color:"#e8e6f0",flex:1}}>{dmTarget.displayName}</span>
                          {/* 채팅방 삭제 */}
                            ...
                            return(
                              <div key={msg.id}>
                                {showDate&&(
                                  <div style={{textAlign:"center",margin:"10px 0 6px",display:"flex",alignItems:"center",gap:"8px"}}>
                                    <div style={{flex:1,height:"1px",background:"rgba(255,255,255,0.08)"}}/>
                                    <span style={{fontSize:"0.6rem",color:"rgba(255,255,255,0.3)",padding:"2px 8px",borderRadius:"8px"}}>{getDateLabel(msg.createdAt)}</span>
                                    <div style={{flex:1,height:"1px",background:"rgba(255,255,255,0.08)"}}/>
                                  </div>
                                )}
                                <div style={{display:"flex",gap:"8px",alignItems:"flex-end",flexDirection:isMe?"row-reverse":"row",padding:"2px 4px"}}>
                                  ...
                                  <div style={{maxWidth:"75%"}}>
                                    {/* 답장 미리보기 */}
                                    {msg.replyTo&&(
                                      <div style={{borderLeft:"2px solid rgba(196,160,80,0.5)",marginBottom:"4px",fontSize:"0.68rem",color:"rgba(255,255,255,0.4)",background:"rgba(255,255,255,0.04)",borderRadius:"0 6px 6px 0",padding:"3px 8px"}}>
                                    ...
                                    <div style={{padding:"9px 13px",borderRadius:isMe?"14px 14px 4px 14px":"14px 14px 14px 4px",background:isEditing?"rgba(196,160,80,0.3)":isMe?"#c4a050":"rgba(255,255,255,0.08)",color:isMe?"#17161C":"#e8e6f0",fontSize:"0.88rem",lineHeight:1.4,wordBreak:"break-word"}}>
                                      {msg.text}
                                    </div>
                                    <div style={{fontSize:"0.6rem",color:"rgba(255,255,255,0.25)",marginTop:"3px",display:"flex",gap:"5px",justifyContent:isMe?"flex-end":"flex-start",alignItems:"center"}}>
                                      {timeStr}
                                      {msg.edited&&<span style={{fontStyle:"italic"}}>Edited</span>}
                                      <button onClick={()=>setReplyTo(msg)} style={{background:"none",border:"none",cursor:"pointer",color:"rgba(255,255,255,0.25)",fontSize:"0.65rem"}}>↩</button>
                                      {isMe&&<>
                        ...
                        <div style={{paddingTop:"8px",borderTop:"1px solid rgba(255,255,255,0.08)"}}>
                          ...
                          {dmEditingMsgId&&(
                            <div style={{display:"flex",alignItems:"center",gap:"8px",padding:"6px 10px",background:"rgba(196,160,80,0.1)",borderRadius:"8px",marginBottom:"6px",fontSize:"0.75rem",color:"#c4a050"}}>
                              <Icon name="edit" size={12} color="#c4a050"/>
                              <span style={{flex:1,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",color:"rgba(255,255,255,0.5)"}}>{dmEditingText}</span>
