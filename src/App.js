...
// ── SVG 아이콘 컴포넌트 ──
function AnalyticsSection({studyLog,words,uiLang,T,showAnalytics,setShowAnalytics,setWords,showToast}){
          ...
          <div>
            <div style={{fontSize:"0.78rem",fontWeight:600,color:"rgba(255,255,255,0.6)",marginBottom:"8px",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
              ...
              <div style={{display:"flex",alignItems:"center",gap:"8px",fontSize:"0.6rem",color:"rgba(255,255,255,0.3)"}}>
                <span style={{display:"flex",alignItems:"center",gap:"3px"}}><Icon name="hard" size={9} color="#f07050"/>어려움</span>
                <span style={{display:"flex",alignItems:"center",gap:"3px"}}><Icon name="learning" size={9} color="#9090b0"/>학습중</span>
                <span style={{display:"flex",alignItems:"center",gap:"3px"}}><Icon name="mastered" size={9} color="#60c880"/>암기완료</span>
              </div>
            </div>
            {top10.length===0?(
        ...
        {!isQuizActive&&(
          <div style={{paddingBottom:"80px"}}>
            ...
            {activeTab==="settings"&&(
              <div style={{display:"flex",flexDirection:"column",gap:"10px"}}>
                {/* 학습 분석 */}
                <AnalyticsSection studyLog={studyLog} words={words} uiLang={uiLang} T={T} showAnalytics={showAnalytics} setShowAnalytics={setShowAnalytics} setWords={setWords} showToast={showToast}/>
                {/* 계정 */}
                <div style={S.card}>
