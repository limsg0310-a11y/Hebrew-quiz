...
// ── SVG 아이콘 컴포넌트 ──
function AnalyticsSection({studyLog,words,uiLang,T,showAnalytics,setShowAnalytics}){
          ...
          <div>
            ...
            {top10.length===0?(
              ...
              <div style={{display:"flex",flexDirection:"column",gap:"5px"}}>
                {top10.map((w,i)=>(
                  <div key={w.id} style={{display:"flex",alignItems:"center",gap:"8px",padding:"8px 10px",background:"rgba(255,255,255,0.03)",borderRadius:"8px",border:"1px solid rgba(255,255,255,0.06)"}}>
                    <span style={{fontSize:"0.72rem",color:"rgba(255,255,255,0.25)",minWidth:"16px",textAlign:"right"}}>{i+1}</span>
                    <span style={{fontFamily:"Arial",direction:"rtl",fontSize:"0.95rem",color:"#c4a050",flex:1,minWidth:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{w.hebrew}</span>
                    <span style={{fontSize:"0.72rem",color:"rgba(255,255,255,0.45)",maxWidth:"100px",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{w.meaning}</span>
                    <div style={{display:"flex",alignItems:"center",gap:"3px",flexShrink:0}}>
                      <Icon name="hard" size={11} color="#f07050"/>
                      <span style={{fontSize:"0.7rem",color:"#f07050",fontWeight:700}}>{T.wrongTimes(w.wrongCount)}</span>
                    </div>
                    <div style={{width:"50px",height:"5px",borderRadius:"3px",background:"rgba(255,255,255,0.08)",overflow:"hidden",flexShrink:0}}>
                      <div style={{height:"100%",borderRadius:"3px",background:"linear-gradient(90deg,#f07050,#c4a050)",width:`${Math.min(100,(w.wrongCount/Math.max(...top10.map(x=>x.wrongCount)))*100)}%`}}/>
                    </div>
                  </div>
                ))}
              </div>
        ...
        {!isQuizActive&&(
          <div style={{paddingBottom:"80px"}}>
            ...
            {activeTab==="settings"&&(
              <div style={{display:"flex",flexDirection:"column",gap:"10px"}}>
                {/* 학습 분석 */}
                <AnalyticsSection studyLog={studyLog} words={words} uiLang={uiLang} T={T} showAnalytics={showAnalytics} setShowAnalytics={setShowAnalytics}/>
                {/* 계정 */}
                <div style={S.card}>
