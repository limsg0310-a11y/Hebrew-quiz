          ...
          <div style={{...Mo.box,maxWidth:"300px"}} onClick={e=>e.stopPropagation()}>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:"4px",marginBottom:"12px"}}>
              {wallets.map(wl=>{
                ...
                const borderColor=inW?"rgba(232,74,95,0.28)":TL;
                const divBorder=inW?wl.color:"rgba(255,255,255,0.2)";
                return (
                  <button key={wl.id} onClick={()=>toggleWordInWallet(wl.id,walletPickWord)} style={{display:"flex",alignItems:"center",gap:"9px",padding:"9px 12px",borderRadius:"2px",background:inW?"rgba(232,74,95,0.07)":"rgba(255,255,255,0.02)",border:"1px solid "+borderColor,cursor:"pointer",textAlign:"left"}}>
                    <div style={{width:"13px",height:"13px",borderRadius:"2px",flexShrink:0,background:inW?wl.color:"transparent",border:"1px solid "+divBorder,display:"flex",alignItems:"center",justifyContent:"center"}}>
