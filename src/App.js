                      ...
                      <div style={{flex:1,overflowY:"auto"}}>
                        ...
                        <div style={{...S.card,marginBottom:"12px"}}>
                          ...
                          {friendSearchResult&&(friendSearchResult.notFound?(
                            <div style={{fontSize:"0.8rem",color:"#f07050",textAlign:"center",padding:"8px"}}>찾을 수 없어요.</div>
                          ):(
        ...
        {!isQuizActive&&(
          <nav style={{position:"fixed",bottom:0,left:0,right:0,background:"#17161C",borderTop:"1px solid rgba(255,255,255,0.1)",display:"flex",zIndex:200,paddingBottom:"env(safe-area-inset-bottom)"}}>
            {[
              ...
              {id:"chat",emoji:"💬",label:T.tab_chat, badge:user&&friendRequests.length>0?friendRequests.length:null},
            ].map(tab=>(
