...
<div style={{width:"36px",height:"36px",borderRadius:"8px",overflow:"hidden",flexShrink:0,border:`1px solid ${theme==="light"?"rgba(196,160,80,0.35)":"rgba(196,160,80,0.4)"}`,boxShadow:"0 2px 10px rgba(0,0,0,0.2)",background:"transparent",display:"flex",alignItems:"center",justifyContent:"center"}}>
